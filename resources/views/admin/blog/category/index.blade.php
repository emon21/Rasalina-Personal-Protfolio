                ...
                <div class="col-12">
                    <div class="card">
                        <div
                            ...
                            <h5 class="my-0 text-success text-bold"><i class="mdi mdi-bullseye-arrow me-1"></i> All Category
                            </h5>
                            <a href="{{ route('admin.category.create') }}" class="btn btn-outline-success">Create Category</a>
                        </div>
